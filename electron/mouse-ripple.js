...
class RippleSystem {
    ...
    resize() {
        ...
        // Don't scale context - we'll handle DPR in drawing instead
        // This ensures mouse coordinates match exactly where we draw
    }
    ...
    drawRipple(ripple, opacity) {
        ...
        const x = ripple.x * dpr;
        const y = ripple.y * dpr;
        const size = ripple.size * dpr;
        ...
        ctx.lineWidth = (ripple.type === 'click' ? 3 : 2) * dpr;
        ctx.stroke();
